...
function createGooglePayTransaction(callback) {
  ...
  transactionRequest.setAmount(getRandomAmount());
...
const _createGooglePayTransaction = createGooglePayTransaction;
export { _createGooglePayTransaction as createGooglePayTransaction };
