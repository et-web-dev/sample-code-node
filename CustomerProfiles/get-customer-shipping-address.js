...
function getCustomerShippingAddress(
  ...
  var ctrl = new ApiControllers.GetCustomerShippingAddressController(
    getRequest.getJSON()
  );
  ...
  ctrl.execute(function () {
    ...
    var response = new ApiContracts.GetCustomerShippingAddressResponse(
      apiResponse
    );
    ...
    if (response != null) {
      if (
        ...
        console.log(
          response.getAddress().getFirstName() +
            ' ' +
            response.getAddress().getLastName()
        );
