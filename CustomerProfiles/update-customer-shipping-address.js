...
function updateCustomerShippingAddress(
  ...
  var ctrl = new ApiControllers.UpdateCustomerShippingAddressController(
  ...
  ctrl.execute(function () {
    ...
    var response = new ApiContracts.UpdateCustomerShippingAddressResponse(
      apiResponse
    );
    ...
    if (response != null) {
      if (
        ...
        console.log(
          'Successfully updated a customer shipping profile with id: ' +
            customerAddressId
        );
      } else {
...
const _updateCustomerShippingAddress = updateCustomerShippingAddress;
export { _updateCustomerShippingAddress as updateCustomerShippingAddress };
