...
function getCustomerPaymentProfileList(callback) {
  ...
  var search =
    ApiContracts.CustomerPaymentProfileSearchTypeEnum.CARDSEXPIRINGINMONTH;
  var month = '2020-12';
  ...
  var ctrl = new ApiControllers.GetCustomerPaymentProfileListController(
    getRequest.getJSON()
  );
  ...
  ctrl.execute(function () {
    ...
    var response = new ApiContracts.GetCustomerPaymentProfileListResponse(
      apiResponse
    );
      ...
      if (
        ...
        for (var i = 0; i < profiles.length; i++) {
          ...
          if (profiles[i].payment.creditCard) {
            ...
            console.log(
              'Bank Account: ' + profiles[i].payment.bankAccount.accountNumber
            );
          }
          console.log('');
        }
...
const _getCustomerPaymentProfileList = getCustomerPaymentProfileList;
export { _getCustomerPaymentProfileList as getCustomerPaymentProfileList };
