...
function createCustomerShippingAddress(customerProfileId, callback) {
  ...
  var ctrl = new ApiControllers.CreateCustomerShippingAddressController(
  ...
  ctrl.execute(function () {
    ...
    var response = new ApiContracts.CreateCustomerShippingAddressResponse(
      apiResponse
    );
    ...
    if (response != null) {
      if (
        ...
        console.log(
          'Successfully created a customer payment profile with id: ' +
...
const _createCustomerShippingAddress = createCustomerShippingAddress;
export { _createCustomerShippingAddress as createCustomerShippingAddress };
