...
function validateCustomerPaymentProfile(
  ...
  var ctrl = new ApiControllers.ValidateCustomerPaymentProfileController(
  ...
  ctrl.execute(function () {
    ...
    var response = new ApiContracts.ValidateCustomerPaymentProfileResponse(
      apiResponse
    );
    ...
    if (response != null) {
      if (
        ...
        console.log(
          'Successfully validated the customer payment profile with id : ' +
            customerPaymentProfileId
        );
      } else {
...
const _validateCustomerPaymentProfile = validateCustomerPaymentProfile;
export { _validateCustomerPaymentProfile as validateCustomerPaymentProfile };
